...
const Subcollection = () => {
  ...
  " class="btn btn-secondary">30x60cm</a> */}
          ...
          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
            ...
            >
              <div className="img-holder">
                <img src="img/previes/abs/NANO-BLACK.jpg" alt="Awesome Image" />
              </div>
              <div className="text-holder">
                <div className="post-date">
                  <h3>
          ...
          <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
            ...
            >
              <div className="img-holder">
                <img src="img/previes/abs/ONYX-CHOCO.jpg" alt="Awesome Image" />
              </div>
              <div className="text-holder">
                <div className="post-date">
                ...
                <div className="text">
                  <p>
                    Experience the epitome of luxury with our stunning colorbody
                    tiles, where impeccable designs meet captivating beauty.
                  </p>
                </div>
                <div className="meta-box">
                  <ul className="meta-info">
